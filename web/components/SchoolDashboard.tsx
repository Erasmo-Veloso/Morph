...
export function SchoolDashboard() {
  ...
  return <main className="school-shell">
    ...
    <section className="school-hero"><div><p className="landing-eyebrow"><span /> VISÃO DA SCHOOL BUBBLE</p><h1>O contexto certo<br />para cada aula.</h1><p>A escola define uma área pedagógica, associa a comunidade e entrega uma regra que o dispositivo consegue executar localmente.</p></div><div className="school-health"><span className="live-dot" /><strong>School Bubble configurável</strong><small>GPS local · sem histórico de localização</small></div></section>
    ...
    <section className="school-grid school-grid-bubble">
      ...
      <aside className="school-card school-policy-card"><div className="school-card-header"><div><p>POLÍTICA LOCAL</p><h2>Como o Android decide</h2></div><CircleAlert size={20} /></div><ol className="school-policy-list"><li><span>01</span><div><strong>Recebe a Capsule</strong><small>A Bubble configurada é incluída numa cópia local e assinável.</small></div></li><li><span>02</span><div><strong>Confirma o campus</strong><small>Compara GPS actual, precisão e raio — não envia coordenadas.</small></div></li><li><span>03</span><div><strong>Activa a aula</strong><small>Dentro da Bubble, as capacidades pedagógicas ficam disponíveis.</small></div></li><li><span>04</span><div><strong>Aplica tolerância</strong><small>Sem GPS, mantém o último estado válido por {Math.round(bubble.policy.unknown_location_grace_seconds / 60)} min.</small></div></li></ol><div className="school-policy-note"><ShieldCheck size={17} /> Fora da Bubble, a política da aula é suspensa; não há bloqueio permanente nem rastreamento contínuo.</div></aside>
    </section>
