...
export function StudioShell({
  ...
  return <main className="studio-shell">
    <aside className="studio-sidebar">
      ...
      <div className="studio-profile"><span className="studio-avatar">PD</span><span><strong>Professor da demonstração</strong><small>Conta demo</small></span><ChevronDown size={16} /></div>
    </aside>
    <section className="studio-main">
      <header className="studio-topbar">
        ...
        <div className="studio-topbar-actions"><span className="studio-live-status"><span />{status}</span><button className="studio-icon-button" type="button" aria-label="Notificações"><Bell size={20} /><i /></button><span className="studio-divider" /><span className="studio-account"><span className="studio-avatar">PD</span><span><strong>Professor da demonstração</strong><small>Escola de demonstração</small></span><ChevronDown size={16} /></span></div>
      </header>
