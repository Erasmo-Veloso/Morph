  ...
  return <main className="studio-shell">
    <aside className="studio-sidebar">
      <Link className="studio-brand" href="/" aria-label="Morph, página inicial">
        <Image src="/brand/logo-lockup-horizontal.png" alt="morph" width={170} height={48} priority />
      </Link>
      ...
      <div className="studio-profile"><span className="studio-avatar" aria-hidden="true"><UserRound size={18} /></span><span><strong>Maria Ribeiro</strong><small>Professora</small></span><ChevronDown size={16} /></div>
    </aside>
    <section className="studio-main">
      <header className="studio-topbar">
        ...
        <div className="studio-topbar-actions"><span className="studio-live-status"><span />{status}</span><button className="studio-icon-button" type="button" aria-label="Notificações"><Bell size={20} /><i /></button><span className="studio-divider" /><span className="studio-account"><span className="studio-avatar" aria-hidden="true"><UserRound size={18} /></span><span><strong>Maria Ribeiro</strong><small>Escola Secundária do Porto</small></span><ChevronDown size={16} /></span></div>
      </header>
